...
```{r Daily Double Heatmap by year, fig.height = 10}
dd %>% 
  ...
  ggtitle("Percent of Jeopardy Daily Doubles by Year") +
...
dd_2 <- dd %>%
  ...
  geom_tile(color = "white") +
   labs(x = NULL, 
        y = NULL, 
        fill = "Percent of Daily Doubles") +
  ggtitle("Percent of Jeopardy Daily Doubles Round 2") +
  scale_fill_continuous(high = "dodgerblue4", 
                        low = "azure") +
  theme(legend.position = "bottom", 
        legend.box = "horizontal") +
