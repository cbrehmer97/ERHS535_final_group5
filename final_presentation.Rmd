...
- Input
  + categories_unique: data frame with categories asked in each episode
  + categories_asked: information about questions that had been asked
...
- Output
  ...
  + perfect_pos: dataframe with perfect game

## Examples

- Input
  + dd_perfect: 
  + dd_weight: data frame containing the weight of each 
...
- Output
  + dd_perfect: perfect data frame of daily double categories where the weight is mapped to the unasked questions
